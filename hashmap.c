 ...
 */
unsigned int
hashmap_hash_int (hashmap_map * m, char *keystring) {
 ...
 */
int
hashmap_hash (map_t in, char *key) {
    int curr;
    int i;
 ...
 */
int
hashmap_put (map_t in, char *key, any_t value) {
    int index;
    hashmap_map *m;
 ...
 */
int
hashmap_get (map_t in, char *key, any_t * arg) {
    int curr;
    int i;
    hashmap_map *m;
 ...
 */
int
hashmap_remove (map_t in, char *key) {
    int i;
    int curr;
    hashmap_map *m;
